        ...
        switch (_a.label) {
            case 0:
                exports.redisClient.on('error', function (error) {
                    logger_1["default"].error('Redis:', "Could not establish a connection with redis. ".concat(error));
                });
                return [4 /*yield*/, exports.redisClient.connect()];
            case 1:
                _a.sent();
                return [2 /*return*/, exports.redisClient];
        }
    });
}); };
exports["default"] = initializeRedis;
