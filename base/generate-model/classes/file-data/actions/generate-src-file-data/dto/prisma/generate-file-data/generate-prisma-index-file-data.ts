...
import { ${modelName.singular.pascalCase}CursorInput } from './${modelName.singular.paramCase}-cursor.input';
...
export { ${modelName.singular.pascalCase}Input, ${modelName.singular.pascalCase}CursorInput, ${modelName.singular.pascalCase}WhereInput, ${modelName.singular.pascalCase}OrderByInput };`;
